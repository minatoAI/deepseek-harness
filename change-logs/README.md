...
- **2026-08-18** — [为工具参数校验错误补充完整归属路径](2026-08-18-tool-argument-diagnostic-paths.md)：`defineTool()` 以工具名作为运行时校验根路径，使直接调用与 Code Mode 子分发明确报告 `run_code.description`、`pwsh.description` 等完整参数路径。
