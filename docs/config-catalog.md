...
Requires: `agents` · `sessions` · `sessionPersistence` · `sessionProjections` · `subagents` · `tools`
...
Source: [`packages/experimental/agent-team/src/types.ts:167`](../packages/experimental/agent-team/src/types.ts)
...
Source: [`packages/llm/llm-pi-ai/src/config.ts:269`](../packages/llm/llm-pi-ai/src/config.ts)
