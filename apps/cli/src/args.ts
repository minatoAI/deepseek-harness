...
export type DshInvocation = ProfileInvocation | DumpConfigInvocation | DumpConfigSchemaInvocation | PluginInvocation | PluginCheckInvocation
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  if (first === 'plugin') {
    ...
    plugin
      ...
      .option('--profile <name>', 'the profile whose plugins to manage (initialized on first use)', selectProfile)
      .allowUnknownOption()
