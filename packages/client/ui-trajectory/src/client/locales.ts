...
export const zh = {
  ...
  'details.failure.region': '模型在当前地区不可用（403）。密钥有效，请检查出口地区或 VPN，稍后重试，或切换模型或提供方，详见会话日志。',
  'details.retry': '重试',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'details.failure.region': 'Model unavailable in the current region (403). The key is valid. Check the egress region or VPN, retry later, or switch model or provider. See the session log.',
  'details.retry': 'Retry',
