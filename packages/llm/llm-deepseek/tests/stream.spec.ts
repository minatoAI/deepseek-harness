...
describe('SSE framing and provider failures', () => {
  ...
  it.each([
    [401, {}, 'AUTH'], [403, {}, 'AUTH'],
    [403, { type: 'RegionError', message: 'not available in region' }, 'REGION_UNSUPPORTED'],
    [403, { message: 'This model is not available in your country' }, 'REGION_UNSUPPORTED'], [402, {}, 'QUOTA'], [429, {}, 'RATE_LIMIT'],
